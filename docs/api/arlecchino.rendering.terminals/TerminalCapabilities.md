...
| [`NearestPaletteColor(Rgb)`](#nearestpalettecolor-rgb) | Picks the palette colour closest to an exact one. This is the conversion [`RgbTermColor`](../arlecchino.rendering.colors/RgbTermColor.md) uses when the terminal cannot do 24-bit, available for your own rendering. |
...
**Returns** [`ColorSupport`](../arlecchino.rendering.colors/ColorSupport.md) — The detected level of colour support.
...
**Returns** [`ColorSupport`](../arlecchino.rendering.colors/ColorSupport.md) — The level of colour support those values imply.
...
Picks the palette colour closest to an exact one. This is the conversion [`RgbTermColor`](../arlecchino.rendering.colors/RgbTermColor.md) uses when the terminal cannot do 24-bit, available for your own rendering.

**Parameters**

| Name | Type | Description |
|---|---|---|
| `color` | [`Rgb`](../arlecchino.rendering.colors/Rgb.md) | The colour to approximate. |

**Returns** [`TerminalColor`](../arlecchino.rendering.colors/TerminalColor.md) — The nearest of the sixteen ANSI colours.
