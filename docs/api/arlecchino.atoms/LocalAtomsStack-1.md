...
A stack the undo history never sees: where the user has been, the folders walked into, the screens over one another. It notifies and asks for a frame exactly as a [`TrackedAtomsStack`](../arlecchino.atoms/TrackedAtomsStack-1.md) does.
