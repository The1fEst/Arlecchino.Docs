...
A line of text: free text, a secret, an email or a link. The built-in format check runs before [`TextModal.Validate`](../arlecchino.modals/TextModal.md#validate), so your validator only sees input that already looks right.
...
**Implements** [`ITextEntryModal`](../arlecchino.modals/ITextEntryModal.md), [`IAffixedModal`](../arlecchino.modals/IAffixedModal.md)
...
**Type** [`TextFormat`](../arlecchino.modals/TextFormat.md)
