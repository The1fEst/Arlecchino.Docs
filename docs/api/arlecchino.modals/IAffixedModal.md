...
**Implemented by** [`ITextEntryModal`](../arlecchino.modals/ITextEntryModal.md), [`NumberModal`](../arlecchino.modals/NumberModal.md), [`NumericModal`](../arlecchino.modals/NumericModal.md), [`SliderModal`](../arlecchino.modals/SliderModal.md), [`TextModal`](../arlecchino.modals/TextModal.md)
