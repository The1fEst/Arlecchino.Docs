...
A colour picked on three sliders. Hue, saturation and lightness are edited rather than the raw channels because they are what people reach for; the result is converted to [`Rgb`](../arlecchino.rendering/Rgb.md) on the way out. Both directions round to whole units, so feeding a colour back in can shift it by one.
...
**Type** [`ColorChannel`](../arlecchino.modals/ColorChannel.md)
...
**Type** `Action<T>`&lt;[`Rgb`](../arlecchino.rendering/Rgb.md)&gt;
...
**Type** [`Rgb`](../arlecchino.rendering/Rgb.md)
...
| Name | Type | Description |
|---|---|---|
| `channel` | [`ColorChannel`](../arlecchino.modals/ColorChannel.md) | The slider to ask about. |
...
| Name | Type | Description |
|---|---|---|
| `channel` | [`ColorChannel`](../arlecchino.modals/ColorChannel.md) | The slider to move. |
...
| Name | Type | Description |
|---|---|---|
| `color` | [`Rgb`](../arlecchino.rendering/Rgb.md) | The colour to start from. |
...
| Name | Type | Description |
|---|---|---|
| `channel` | [`ColorChannel`](../arlecchino.modals/ColorChannel.md) | The slider to read. |
