...
**Type** `Func<T, TResult>`&lt;[`TreeNode`](../arlecchino.widgets.lists/TreeNode-1.md)&lt;`T`&gt;, [`ViewRoute`](../arlecchino.navigation/ViewRoute.md)&gt;
...
**Type** `Action<T>`&lt;[`TreeNode`](../arlecchino.widgets.lists/TreeNode-1.md)&lt;`T`&gt;&gt;
...
**Type** [`TreeNode`](../arlecchino.widgets.lists/TreeNode-1.md)&lt;`T`&gt;
