...
| Member | Summary |
|---|---|
| [`Closing`](#closing) | Cancelled when the screen goes away. Pass it into work you start yourself so it stops with the screen rather than with the application. It stays readable afterwards, so background work that comes back late can still see that the screen has gone. |
...
Cancelled when the screen goes away. Pass it into work you start yourself so it stops with the screen rather than with the application. It stays readable afterwards, so background work that comes back late can still see that the screen has gone.
